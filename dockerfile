...
# FROM xiosi/root:ros-cuda11.3-cudnn8.2-ubuntu16.04
...
RUN chmod +x /root/final-slam/docker/lib.sh && /root/final-slam/docker/lib.sh
# # Load ROS environment at each run
RUN chmod 755 /root/final-slam/docker/entrypoint.sh
ENTRYPOINT ["/root/final-slam/docker/entrypoint.sh"]
